...
#			cat $3 | sed -E 's/(.*),(.*),(.*),(.*),(.*),(.*),(.*)/\2 \1,\3,\4,\7/g' | sort -r -k 1 | 
	...
	5)
		...
		then
#			cat $3 | sed -E 's/(.*),(.*),(.*),(.*),(.*),(.*),(.*)/\2 \1,\3,\4,\7/g' | sort -r -k 1 | 
			cat $3 | cut -d ',' -f 1 | sed -E 's/Jan/01/g' | sed -E 's/Feb/02/g' | sed -E 's/Mar/03/g' | sed -E 's/Apr/04/g' | sed -E 's/May/05/g' | sed -E 's/Jun/06/g' | sed -E 's/Jul/07/g' | sed -E 's/Aug/08/g' | sed -E 's/Sep/09/g' | sed -E 's/Oct/10/g' | sed -E 's/Nov/11/g' | sed -E 's/Dec/12/g' | sed -E 's/(.*) (.*) (.*) - (.*)/\3\/\1\/\2 \4/g' | head -n 10	
